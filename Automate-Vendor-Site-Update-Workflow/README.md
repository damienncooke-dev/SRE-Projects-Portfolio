...
1. **Data Input**
2. File is downloaded from a website and saved to local directory/root folder.
3. File contents is extracted to directory in root folder [supplier-data:images, supplier-data:descriptions].
4. **Data Processing**  
